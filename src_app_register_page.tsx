...
async function validateAndUseReferralCode(code: string, username: string): Promise<{ saldo: number; level: number; expiration_date: string; uplink: string } | null> {
    if (!code) return null;
